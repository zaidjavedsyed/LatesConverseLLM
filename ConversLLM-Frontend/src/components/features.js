...
const features = [
  {
    ...
    description:
      "Saves your hassle of web surfing by quickly answering your queries accurate",
  ...
  },
  {
    ...
    description:
      "Hastle free integration to any website as per the requirements of clients/owners.",
    bgColor: "bg-pink-50",
  ...
  {
    title: "Tailored Data Training",
    description:
      "Chatbot specifically trained on the tailored data of the provided URL of website",
    bgColor: "bg-teal-50",
  ...
  {
    title: "Instantaneous Responses",
    description:
      "The chatbot addresses user queries on website content, eradicating searches",
